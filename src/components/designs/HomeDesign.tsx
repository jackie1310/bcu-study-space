...
export const BackgroundCircles = ({ parallaxRef }: any) => {
  ...
  return (
    <div className="absolute top-[0.1rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:top-[0.2rem] xl:top-[0.3rem]">
      <Rings />
      ...
      <MouseParallax strength={0.07} parallaxContainerRef={parallaxRef}>
        ...
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[73deg]">
          <div
            className={`w-8 h-8 -ml-1 -mt-32 bg-gradient-to-b from-[#C2DCFA] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[90deg]">
          <div
            className={`w-6 h-6 -ml-3 -mt-3 bg-gradient-to-b from-[#cac657] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom -rotate-[30deg]">
          <div
            className={`w-6 h-6 -ml-1 -mt-50 bg-gradient-to-b from-[#be5077] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />  
        </div>
        <div className="absolute bottom-1/2 left-1/2 w-0.25 h-1/2 origin-bottom rotate-[30deg]">
          <div
            className={`w-6 h-6 -ml-1 -mt-50 bg-gradient-to-b from-[#9169b4] to-[#1A1A32] rounded-full transition-transform duration-500 ease-out ${
              mounted ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
          />  
        </div>
